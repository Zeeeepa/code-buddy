...
const BASE_GROK_TOOLS: GrokTool[] = [
  ...
  },
  {
    ...
    function: {
      name: "find_symbols",
      description:
        "Find code symbols (functions, classes, interfaces, types, constants) by name. Useful for understanding code structure and finding definitions.",
      parameters: {
        type: "object",
        properties: {
          name: {
  ...
  },
  {
    ...
    function: {
      ...
      description:
        "Find all references/usages of a symbol in the codebase. Useful for understanding how a function, class, or variable is used.",
      parameters: {
        type: "object",
        properties: {
          symbol_name: {
  ...
  },
  {
    ...
    function: {
      ...
      description:
        "Find the definition of a symbol (where it's declared). Returns the file, line, and signature.",
      parameters: {
        type: "object",
        properties: {
          symbol_name: {
  ...
  },
  {
    ...
    function: {
      name: "search_multi",
      description:
        "Search for multiple patterns at once with OR (any pattern) or AND (all patterns) logic.",
      parameters: {
        type: "object",
        properties: {
          patterns: {
