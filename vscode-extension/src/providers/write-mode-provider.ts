...
export class WriteModeProvider implements vscode.WebviewViewProvider, vscode.Disposable {
  public static readonly viewType = 'codebuddy.writeMode';

  private view?: vscode.WebviewView;
  private disposables: vscode.Disposable[] = [];
  private isGenerating = false;
  private currentGeneration: { content: string; language: string } | null = null;
  private smartContext: SmartContextManager;
...
- Use descriptive variable and function names`;
   ...
   */
  private extractCodeBlocks(response: string): Array<{ code: string; language: string }> {
   ...
   */
  private async createNewFile(code: string, language: string): Promise<void> {
