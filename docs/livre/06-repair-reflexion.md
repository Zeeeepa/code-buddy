...
│  ├─ 🗂️ Mauvais fichier modifié     : 30%                            │
│  ├─ 📝 Solution partielle          : 25%                            │
│  ├─ 💥 Régression introduite       : 20%                            │
│  └─ 🌫️ Hallucination de code       : 25%                            │
│                                                                      │
│  ────────────────────────────────────────────────────────────────   │
│                                                                      │
│  RÉPARATION ITÉRATIVE (ChatRepair) :                                │
│  ════════════════════════════════════                               │
│  📈 Taux de succès : ~40% (+167% !)                                 │
│                                                                      │
│  📊 Statistiques :                                                  │
│  ├─ Moyenne d'itérations : 2.3                                     │
│  ├─ Médiane : 2 itérations                                         │
│  └─ Maximum utile : 5 itérations                                   │
│                                                                      │
│  Au-delà de 5 itérations, les rendements sont décroissants.        │
│                                                                      │
└─────────────────────────────────────────────────────────────────────┘
```
...
├─────────────────────────────────────────────────────────────────────┤
│                                                                      │
│   Bug Report / Test qui échoue                                      │
│            │                                                         │
│            ▼                                                         │
│   ┌────────────────────┐                                            │
│   │ 1️⃣ LOCALISATION    │ ◄── "Où est le bug exactement ?"          │
│   │   (Fault Location) │     Ochiai, DStar, stack trace             │
│   └─────────┬──────────┘                                            │
│             │                                                        │
│             ▼                                                        │
│   ┌────────────────────┐                                            │
│   │ 2️⃣ GÉNÉRATION      │ ◄── "Propose un correctif"                │
│   │   (Patch Generate) │     LLM avec contexte ciblé               │
│   └─────────┬──────────┘                                            │
│             │                                                        │
│             ▼                                                        │
│   ┌────────────────────┐                                            │
│   │ 3️⃣ VALIDATION      │ ◄── "Est-ce que ça marche ?"              │
│   │   (Test Execution) │     Exécuter les tests                    │
│   └─────────┬──────────┘                                            │
│             │                                                        │
│        ┌────┴────┐                                                  │
│        │ Succès? │                                                  │
...
│             ▼   ▼                                                   │
│   ┌──────────────┐  ┌──────────────┐                               │
│   │ 4️⃣ FEEDBACK  │  │  ✅ TERMINÉ  │                               │
│   │  Analyser    │  │              │                               │
│   │  l'erreur    │  │  Bug corrigé │                               │
│   └──────┬───────┘  └──────────────┘                               │
│          │                                                          │
│          └─────────────────▶ (retour à étape 2 avec feedback)      │
│                                                                      │
│   ⚠️ Maximum 5 itérations (rendements décroissants au-delà)        │
│                                                                      │
└─────────────────────────────────────────────────────────────────────┘
```
...
│  ─────────────────────                                              │
│  │ Ligne │  T1  │  T2  │  T3  │  T4  │ Suspicion │                 │
│  │───────│──────│──────│──────│──────│───────────│                 │
│  │  10   │  ✓   │  ✓   │  ✓   │  ✓   │   0.25    │ Exécutée partout│
│  │  11   │  ✓   │  ✓   │      │  ✓   │   0.45    │ Mixte           │
│  │  12   │      │  ✓   │      │  ✓   │   0.90 ⭐ │ Suspecte !      │
│  │  13   │  ✓   │  ✓   │  ✓   │      │   0.30    │ Mixte           │
│                                                                      │
│  💡 Ligne 12 : Exécutée UNIQUEMENT par les tests qui échouent      │
